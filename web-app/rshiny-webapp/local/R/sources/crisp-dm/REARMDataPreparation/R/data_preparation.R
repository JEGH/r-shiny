...
"------------------------------------------------------------------------------------------------------"
"------------------------------------------------------------------------------------------------------"
#'  prepare data for Classifications Solutions REARM
#' @param res data input
#' @examples
#' #
#' @return list of data in with source label
#' @export
...
"------------------------------------------------------------------------------------------------------"
"------------------------------------------------------------------------------------------------------"
#'  prepare data for Regression Solutions REARM
#' @param res data input
#' @examples
#' #
#' @return data preparated
#' @export
...
#'  prepare data for Classifications Solutions REARM
#' @param res data input
#' @param mode Type of methods of data preparation
#' @examples
#' #
#' @return data preparated
#' @export
